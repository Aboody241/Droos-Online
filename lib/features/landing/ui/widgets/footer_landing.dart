        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Text(
                "جاهز للبدئ؟",
                style: AppTextStyles.black38Bold.copyWith(
                  color: Colors.white,
                  fontSize: 34,
                ),
              ),
              Gap(10),
              Text(
                "انضم إلى آلاف الطلاب والمعلمين الذين يستخدمون منصتنا بالفعل",
                style: AppTextStyles.black20W500.copyWith(color: Colors.white),
              ),
              Gap(30),
              CustomButton1(
                onTap: () {
                ...
                title: "انضم الآن",
                borderall: Border.all(color: Colors.white),
              ),
              Gap(50),
            ],
          ),
